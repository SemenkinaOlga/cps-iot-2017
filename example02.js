...
http.createServer(function(req, res){ // http.createServer([requestListener]) | The requestListener is a function which is automatically added to the 'request' event.
    ...
    res.write("For test write into browser address line http://172.16.22.28:8080/1 \n");
    res.write("command 0 for turning of GREEN led\n");
    res.write("command 1 for turningon GREEN led\n");
    res.write("command 2 for turning to turn of BLUE led\n");
    res.write("command 3 for turning to turn on BLUE led\n");
